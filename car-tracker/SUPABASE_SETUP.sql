...
-- ════════════════════════════════════════════════════════
--  PHOTO STORAGE — run this separately after the above
--  Supabase Dashboard → Storage → New Bucket
--  (see instructions in DEPLOYMENT_GUIDE.md)
-- ════════════════════════════════════════════════════════

-- Add photos column to maintenance table
ALTER TABLE maintenance ADD COLUMN IF NOT EXISTS photos JSONB DEFAULT '[]';

SELECT 'Photos column added! ✅' AS status;
